...
namespace LABTIAPP.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ColorId,Value,Name")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColorId,Value,Name")] Color color)
        {
            if (id != color.ColorId)
            {
                return NotFound();
