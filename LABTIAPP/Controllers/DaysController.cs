...
namespace LABTIAPP.Controllers
{
    ...
    public class DaysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DayId,DayName,DayPosition")] Day day)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DayId,DayName,DayPosition")] Day day)
        {
            if (id != day.DayId)
            {
                return NotFound();
